...
<body>
    ...
    <div class="w3-top">
        <div class="w3-row w3-padding w3-black">
            ...
            <div class="w3-col s3">
                <a href="#menu" class="w3-button w3-block w3-black">WHERE</a>
            </div>
            <div class="w3-col s3">
                <a href="#where" class="w3-button w3-block w3-black">LOGIN</a>
            </div>
        </div>
    </div>

    <header class="w3-display-container w3-content w3-center" style="max-width:1920px">
        <img class="images" src="images/BG6.jpg" alt="BGHead" width="1920" height="600">
    ...
    <div class="w3-sand w3-grayscale w3-large">
        ...
        <div class="w3-container" id="menu">
            <div class="w3-content" style="max-width:700px">
                ...
                <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide">WHERE TO FIND PHUANGNGERN RENTAL</span></h5>
        ...
        <div class="w3-container" id="where" style="padding-bottom:32px;">
            <div class="w3-content" style="max-width:700px">
                <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide">LOGIN/REGISTER</span></h5>
    ...
    <footer class="w3-center w3-light-grey w3-padding-48 w3-large">
        <p>Powered by PHUANGNGERN RENTAL@2021</p>
    </footer>
